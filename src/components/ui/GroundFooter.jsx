...
/**
 * GroundFooter – grassy hill scene (tree, flowers, bushes) rendered in
 * normal document flow at the end of the page, so it only comes into view
 * once the user actually scrolls to the bottom -- unlike a fixed background,
 * it doesn't stay pinned to the viewport while scrolling through content.
 */
